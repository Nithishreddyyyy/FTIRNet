          ...
          >
            ...
            <div className="p-5 bg-white dark:bg-white/[0.03] border-b-2 border-primary-500/20 dark:border-white/5 flex items-center justify-between relative overflow-hidden">
               ...
               <div className="flex items-center gap-4 relative z-10">
                  ...
                  <div>
                    <h3 className="text-base font-black text-gray-950 dark:text-white tracking-tight">AI Assistant</h3>
                    <p className="text-[11px] font-black text-gray-700 dark:text-emerald-400 flex items-center gap-1.5 uppercase tracking-wider">
               ...
               {messages.map((msg) => (
                 ...
                 >
                    <div className={`max-w-[85%] flex flex-col ${msg.type === 'ai' ? 'items-start' : 'items-end'}`}>
                       <div className={`p-4 rounded-[1.5rem] text-sm font-bold leading-relaxed shadow-xl ${
                         msg.type === 'ai' 
                       ...
                       <span className="text-[10px] text-gray-600 dark:text-gray-500 mt-2 uppercase font-black tracking-[0.2em]">{msg.timestamp}</span>
                    </div>
                 </motion.div>
               ))}
               ...
               <div className="relative group">
                  ...
                  <div className="relative flex items-center gap-3">
                     <div className="flex-1 relative">
                        ...
                        />
                        <Paperclip className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 hover:text-primary-800 cursor-pointer transition-colors" />
                     </div>
                     <button 
                        onClick={() => handleSend()}
                        className="p-4 bg-primary-700 hover:bg-primary-600 text-white rounded-2xl shadow-[0_10px_25px_rgba(3,105,161,0.4)] transition-all hover:-translate-y-1 active:translate-y-0 active:scale-95 border-b-4 border-primary-900"
                      >
